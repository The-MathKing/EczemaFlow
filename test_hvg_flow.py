...
from run_full_benchmarks import PrecomputedFoldDataset, EczemaFlowNoAttention
...
model = EczemaFlowNoAttention(num_genes=500, num_experts=4, device=device).to(device)
optimizer = optim.AdamW(model.parameters(), lr=2e-3)

print("Training No Context Flow on top 500 HVGs for 20 epochs...")
